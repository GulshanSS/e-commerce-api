...
module.exports = {
  userGetAll: asyncHandler(async (req, res) => {
  ...
  userGetOne: asyncHandler(async (req, res) => {
  ...
  userAddToCart: asyncHandler(async (req, res) => {
    const user = await User.findById(req.user._id);
  ...
  userMyOrder: asyncHandler(async (req, res) => {
  ...
  likeProduct: asyncHandler(async (req, res) => {
    let updatedUsers = [];
    const product = await Product.findById(req.params.id);
    if (!product) {
  ...
  cancelDeleteApproval: asyncHandler(async (req, res) => {
